              ...
              <div className="flex flex-wrap gap-2">
                {group.skills.map((skill, index) => (
                  <motion.span
                    ...
                    className="px-3 py-2 bg-gradient-to-r from-purple-600 to-pink-500 rounded-full font-medium shadow-md hover:shadow-lg transition-all duration-200 flex items-center gap-2"
                  >
